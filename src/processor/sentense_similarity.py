...
def text_similarity_check(text_to_match, compare_list, threshold=100):
    ...
    top_text_with_scores = idx_text_score_list.sort(key=lambda x: x[2])[:5]
    max_score = 0
    print('\n'.join(top_text_with_scores))
